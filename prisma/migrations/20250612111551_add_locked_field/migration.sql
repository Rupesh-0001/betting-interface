...
CREATE TABLE "Round" (
    ...
    "title" TEXT NOT NULL,
    "description" TEXT,
    "optionA" TEXT NOT NULL DEFAULT 'Option A',
    "optionB" TEXT NOT NULL DEFAULT 'Option B',
    "status" TEXT NOT NULL DEFAULT 'ACTIVE',
    "locked" BOOLEAN NOT NULL DEFAULT false,
    "winner" TEXT,
    "totalPoolA" INTEGER NOT NULL DEFAULT 0,
    "totalPoolB" INTEGER NOT NULL DEFAULT 0,
